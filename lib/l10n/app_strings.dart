...
class AppStrings extends ChangeNotifier {
  ...
  static const _strings = {
    'es': {
      ...
      'notif_blocked_body': 'Las notificaciones están desactivadas en Ajustes del sistema. Ve a Ajustes > Apps > Notova > Notificaciones para activarlas.',
      'close': 'Cerrar',
      'delete': 'Eliminar',
      'delete_quest_title': 'Eliminar quest',
      'delete_quest_confirm': '¿Seguro que quieres eliminar esta quest? No se puede deshacer.',
      'save': 'Guardar',
      'error': 'Error',
      'great': '¡Genial!',
      ...
      'schedule': 'Agenda',
      'todays_schedule': 'PRÓXIMOS 7 DÍAS',
      'no_events_day': 'No hay eventos en los próximos 7 días.',
      'day_schedule': 'EVENTOS DEL DÍA',
      'no_events_selected_day': 'No hay eventos este día.',
    ...
    'en': {
      ...
      'notif_blocked_body': 'Notifications are disabled in system Settings. Go to Settings > Apps > Notova > Notifications to enable them.',
      'close': 'Close',
      'delete': 'Delete',
      'delete_quest_title': 'Delete quest',
      'delete_quest_confirm': 'Are you sure you want to delete this quest? This cannot be undone.',
      'save': 'Save',
      'error': 'Error',
      'great': 'Awesome!',
      ...
      'schedule': 'Schedule',
      'todays_schedule': 'NEXT 7 DAYS',
      'no_events_day': 'No events in the next 7 days.',
      'day_schedule': 'DAY EVENTS',
      'no_events_selected_day': 'No events on this day.',
